...
/*  rate slider */
const container = document.querySelector('.slider__box') as Element
const btn = document.querySelector('.slider__btn') as Element
const color = document.querySelector('.slider__color') as Element
const tooltip = document.querySelector('.slider__tooltip') as Element
...
const rotation = (target: Element, val: number) => {
  target.style.transform = `rotate(${val}deg)`
}

const dragElement = (target: Element, btn: Element) => {
